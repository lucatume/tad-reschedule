...
class tad_RescheduleTest extends \WP_UnitTestCase
{
    ...
    public function it_should_schedule_the_hook()
    {
        ...
        $wp_schedule_single_event->wasCalledWithOnce($args);
    }
    ...
    /**
     * @test
     * it should append timestamp argument as last argument when rescheduling hook
     */
    public function it_should_append_timestamp_argument_as_last_argument_when_rescheduling_hook()
    {
        $wp_schedule_single_event = Test::replace('wp_schedule_single_event');
